 ...
 *
 * A list to hold ShoppingCart Objects, used to hold 
 * a history of ShoppinCart transactions
 * 
 * updated 3/17/2023
 */
public class TransactionList extends 
	LinkedList<ShoppingCart> implements Serializable{
	...
	*/
	...
	public boolean addTransaction (ShoppingCart cart) {
		//System.out.println("TransList.add() line 34: add() is " + 
			//transactionList.add(cart));
		transactionList.add(cart);
		//System.out.println("TransList.add() line 35: add() 
			//transAction.toString " + transactionList.toString());
		return true;
	} //
	...
	public String getTransactionsOnDate(String date) {
		...
		for(ShoppingCart cart: transactionList) {
			System.out.println("TransList getTrans line 82: .equals is " + 
					cart.getStringDate().equals(date));
	...
	public String toString() {
		...
		if (transactionList.isEmpty()) {
			...
			for (ShoppingCart cart : transactionList) {
				//System.out.println("TransList.toString line 84: "
						//+ "cart.toString() \n" + cart.toString());
				string.append(cart.toString());
			}		
		}
