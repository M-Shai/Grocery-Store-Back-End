...
import j.a.b.s.ics372.gp1.grocerystore.business.collections.*;
/**
...
public class Member extends Entity {
	...
	public static boolean save(ObjectOutputStream output) throws IOException {
		try {
			output.writeObject(memberIdCounter);
			System.out.println("ln 147 write memberIdcounter succesful");
			return true;
		}catch (IOException ioe) {
			System.out.println("ln 150 write memberIdcounter failed");
			ioe.printStackTrace();
			return false;
		}
